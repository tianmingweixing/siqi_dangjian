...
import com.siqi_dangjian.bean.FileEntity;
...
public class VedioUploadTool {
    ...
    public FileEntity createFile(MultipartFile multipartFile, HttpServletRequest request) {
        ...
        if (bflag) {
            String logoPathDir = CommonString.FILE_VEDIO_PATH;
            String logoRealPathDir = CommonString.FILE_PARENT_PATH+logoPathDir;
            // 上传到本地磁盘
